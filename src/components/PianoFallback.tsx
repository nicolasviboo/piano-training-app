...
export default function PianoFallback({
  ...
  return (
    <div className="bg-gradient-to-b from-gray-200 to-gray-300 p-6 rounded-lg shadow-lg overflow-x-auto">
      <h3 className="text-lg font-semibold mb-4 text-gray-800">On-Screen Piano</h3>
      <div className="flex justify-center">
        <div className="inline-flex bg-gray-800 p-4 rounded-lg shadow-inner">
